...
<head>
    ...
    <!-- SEO -->
    <meta name="description" content="Descrição breve do site ou página para motores de busca">
    <meta name="keywords" content="palavra-chave1, palavra-chave2, palavra-chave3">
    <meta name="author" content="Seu Nome ou Empresa">

    <!-- Redes sociais (Open Graph / Facebook) -->
    <!-- <meta property="og:title" content="Título da página para redes sociais">
    <meta property="og:description" content="Descrição breve para redes sociais">
    <meta property="og:image" content="URL da imagem de pré-visualização">
    ...
    <meta name="twitter:description" content="Descrição breve para Twitter">
