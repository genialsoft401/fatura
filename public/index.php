                                ...
                                <div class="col-md-3">
                                    <div class="card card-custom p-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="text-primary small"><i class="bi bi-arrow-up-right"></i> <span id="trimestral_volume_dif">+12%</span></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card card-custom p-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="text-success small"><i class="bi bi-arrow-up-right"></i> <span id="month_average_dif">0%</span></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card card-custom p-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="text-primary small"><i class="bi bi-arrow-up-right"></i> <span id="total_customer_dif">0</span></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card card-custom p-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="text-primary small"><i class="bi bi-arrow-up-right"></i> <span id="total_doc_dif">0</span></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="card card-custom p-3">
                                        <div class="d-flex justify-content-between mb-3">
                                            ...
                                            <a href="#" class="small text-primary">Ver todas <i class="bi bi-chevron-right"></i></a>
                                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="card card-custom p-3 p-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="text-primary small fw-semibold">+2 <i class="bi bi-arrow-up-right"></i></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="card card-custom p-3">
                                        ...
                                        <h4 class="fw-bold mt-3" id="rh_absences_month">12</h4>
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="card card-custom p-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="text-primary small">+14 <i class="bi bi-arrow-up-right"></i></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="card card-custom p-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="text-primary small">+3.1% <i class="bi bi-arrow-up-right"></i></span>
                                        </div>
                                    </div>
                                </div>
...
function renderNumbers(data) {
    ...
    $("#trimestral_volume_dif").text(kpis.crescimento ? `${kpis.crescimento}%` : '0%');
    $("#total_customer").text(kpis.clientes || 0);
    $("#total_customer_dif").text(0);
    $("#total_docs").text(kpis.documentos || 0);
    $("#total_doc_dif").text(0);

    [trimestral_volume_dif,
    month_average_dif,
    total_customer_dif,
    total_doc_dif].forEach(el => {
            el.text >= 0
                ? el.className = "text-green small"
...
function loadRHData() {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            $("#rh_absences_month").text(k.absences_month || 0);
