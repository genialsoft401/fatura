...
<style>
    @media print {
        .celula-stack label { display: none !important; }
        .btn-qtd { display: none !important; }
        th:last-child, td:last-child { display: none !important; }
        .btn, .btn-group, #saveStatus, a[href="stock.php"] { display: none !important; }
        input { 
    ...
    <div class="container py-4 mt-5">
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-striped" id="stockTable">
          <thead class="table-dark cor-estoque">
            <tr>
              <th><?= t('Código') ?></th>
              <th><?= t('Nome') ?></th>
              <th><?= t('Categoria') ?></th>
    ...
    async function exportStockView(type) {
        ...
        if (type === 'excel') {
            ...
            doc.autoTable({
                ...
                body: data,
                startY: headerY + 12,
                margin: { top: 10, bottom: 18 }, // reserva rodapé para paginação
            });
