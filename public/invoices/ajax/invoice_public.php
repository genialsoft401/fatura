...
SELECT  ii.tax AS tax_rate,
        ROUND(SUM(ii.unit_price*ii.quantity)
              * (1 - (discount/100)),2) AS tax_base,
...
// ---------- QR ----------
$hash = randomHash();
$qrData = "../public/invoice_public.php?id={$hash}_{$inv['company_id']}/{$inv['id']}";
