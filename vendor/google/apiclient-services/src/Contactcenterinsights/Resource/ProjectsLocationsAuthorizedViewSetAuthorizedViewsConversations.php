...
class_alias(ProjectsLocationsAuthorizedViewSetAuthorizedViewsConversations::class, 'Google_Service_Contactcenterinsights_Resource_ProjectsLocationsAuthorizedViewSetAuthorizedViewsConversations');
